...
public class NameSurferGraph extends GCanvas
	...
	*/
	...
	private void drawTheGraph(ArrayList<NameSurferEntry> entrylist){
		for (int i=0;i<entrylist.size();i++){
			for (int j=0;j<NDECADES;j++){
				String display=entrylist.get(i).getName()+" "+entrylist.get(i).getRank(1900+j*10);
				double x,y;
				x=xdistance*j;
